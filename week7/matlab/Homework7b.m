...
numComponentsToKeep=100

[coeff, score, latent] = pca(x');
variance = 0
for i = [1:length(latent)]
    variance = variance + latent(i);
    fprintf('%d | %s \n', i, num2str(variance, 3)) 
end
bb = score'
%%
...
% after training.
% save the figure to a png file called nn-performance-pca.png

plotperform(tr)
print('nn-performance-pca', '-dpng')
...
% save the figure to a png file called nn-confusion-pca.png

predictions = net(testX)

plotconfusion(testT, predictions)
print('nn-confusion-pca', '-dpng')
...
% Hint: Use plotroc
% save the figure to a png file called nn-roc-pca.png

clusterOutputs = sim(net, bb)
plotroc(t, clusterOutputs)
print('nn-roc-pca', '-dpng')
%%
